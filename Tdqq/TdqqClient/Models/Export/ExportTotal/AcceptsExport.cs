...
{
    class AcceptsExport:ExportBase
    {
        public AcceptsExport(string personDatabase, string selectFeauture, string basicDatabase)
        ...
        public void Export()
        {
            ...
            {
                MessageBox.Show(null, "无异议声明书导出成功",
        ...
        private void ExportF(object p)
        {
            ...
            try
            {
                ...
                ExportBase export = new AcceptExport(PersonDatabase, SelectFeature, BasicDatabase);
