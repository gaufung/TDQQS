...
{
    class CbfsExport:ExportBase
    {
        public CbfsExport(string personDatabase, string selectFeauture, string basicDatabase)
        ...
        public void Export()
        {
            ...
            {
                MessageBox.Show(null, "承包方调查表导出成功",
                    "信息提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show(null, 
                    "承包方调查表导出失败", "错误提示", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void ExportF(object p)
        {
            ...
            try
            {
                ...
                ExportBase export = new CbfExport(PersonDatabase, SelectFeature, BasicDatabase);
